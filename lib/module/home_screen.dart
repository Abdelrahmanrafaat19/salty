...
class _HomeScreenState extends State<HomeScreen> {
  ...
  @override
  void initState() {
    BlocProvider.of<ProductCubit>(context).getProductMethod();
    super.initState();
  }
              ...
              child: SingleChildScrollView(
                child: Column(children: [
                  ...
                  Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return containerTheBest(
                              width: width * 0.8, height: 1);
                        },
                      )),
                  Container(
                    margin: EdgeInsets.only(
                          ...
                          children: [
                            ...
                            InkWell(
                              /*onTap: () =>
                                ...
                                builder: (context) =>
                                    MyHomePage(page:  CategouriesScreen()),
                              )), */
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                  ...
                  Container(
                    ...
                    height: height * 0.2,
                    margin: EdgeInsets.only(
                        bottom: width * 0.04, right: width * 0.025),
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => MyHomePage(
                                  page: CategouriesScreen(
                                product:
                                    state.productModel.data![index].products ??
                                        [],
                              )),
                            ));
                          },
                          child: stckContainer(context,
                              name: state.productModel.data![index].name),
                        );
                      },
                    ),
                  ),
